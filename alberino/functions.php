...
function application_widgets_init() {
	...
	register_sidebar( array(
		...
		'before_widget' => '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><div class="widget"><div class="single-footer">',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Contact Address', 'application' ),
		'id'            => 'address',
...
//logo shortcode 
function einblicke_round_picture(){
	ob_start();
	global $application_opt;
	$url= $application_opt['einblicke_image']['url'];

?>
	<div class="container">
		<div class="shape background-image" data-src="<?php echo $url;?>">
			<div class="row">
				<ul>
					<li><a href="<?php echo esc_html($application_opt['link_1']);?>" target="_blank"></a></li>
					<li><a href="<?php echo esc_html($application_opt['link_2']);?>" target="_blank"></a></li>
					<li><a href="<?php echo esc_html($application_opt['link_3']);?>" target="_blank"></a></li>
					<li><a href="<?php echo esc_html($application_opt['link_4']);?>" target="_blank"></a></li>
					<li><a href="<?php echo esc_html($application_opt['link_5']);?>" target="_blank"></a></li>
				</ul>
			</div>
		</div>
	</div>
...
add_shortcode('round_picture','einblicke_round_picture' );
