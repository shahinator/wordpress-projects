       ...
       public function setSections() {
		...
		$this->sections[] = array(
			...
			'fields'    => array(
				...
				array(
					'id'        => 'application_quote',
					'type'      => 'text',
					'title'     => esc_html__('Request Quote', 'application'),
					'default'   => esc_html__('Angebot anfordern', 'application')
				),
				array(
					'id'        => 'application_quote_url',
					'type'      => 'text',
					'title'     => esc_html__('Request Quote URL', 'application'),
        ...
        // Home Insurence Content
		$this->sections[] = array(
			'title'     => esc_html__('Home Insurence Content', 'printagram18'),
			'desc'      => esc_html__('Home Insurence Content theme options', 'printagram18'),
			'icon'      => 'el el-adult',
			'fields'    => array(
                array(
					'id'        => 'insurence_title',
					'type'      => 'text',
					'title'     => esc_html__('Home Insurence Title', 'application'),
					'default'   => esc_html__(' Unsere Spezialprodukte für Sie ', 'application')
				),
                array(
					'id'      	=> 'insurence_content',
					'type'    	=> 'editor',
