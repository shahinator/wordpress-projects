...
if ( ! class_exists( 'Xander_Menu_Item_Custom_Fields' ) ) :
	/**
	* Menu Item Custom Fields Loader
	*/
	class Xander_Menu_Item_Custom_Fields {
		...
		*/
		public static function _filter_walker( $walker ) {
			$walker = 'Xander_Menu_Item_Custom_Fields_Walker';
	...
	add_action( 'wp_loaded', array( 'Xander_Menu_Item_Custom_Fields', 'load' ), 9 );
endif;  
