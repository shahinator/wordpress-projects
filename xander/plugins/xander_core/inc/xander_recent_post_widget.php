...
add_action('widgets_init', 'xander_recent_post_load_widgets');
function xander_recent_post_load_widgets(){
	register_widget('xander_recent_post_Widget');
}


class xander_recent_post_Widget extends WP_Widget {
	public function __construct() {
		$widget_ops = array('classname' => 'xander_recent', 'description' => esc_html__('Xander: Recent Posts Widget','xander') );
		$control_ops = array('id_base' => 'xander_recent-widget');
		parent::__construct('xander_recent-widget', esc_html__('Xander: Recent Posts','xander'), $widget_ops, $control_ops);
	}
				...
				<div class="media single-post">
					<div class="pull-left">
						...
						if ( has_post_thumbnail() ) {
							the_post_thumbnail( 'xander-small-thumb', array( 'class' => 'img-responsive' ) );
						}
						else {}
						?>
					</div>
