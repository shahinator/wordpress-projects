...
?>
    ...
    <!-- Hero Start -->
    <section class="hero-area background-image" data-src="<?php echo esc_url($image); ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="hero-col">
...
<?php 
$desk_image = $atts['desk_image']; 
$url =  esc_url( $desk_image['url'] );
$image = xander_resize( $url,540, 670, true, true, true );
 ?>
