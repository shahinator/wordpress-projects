       ...
       public function setSections() {
		...
		$this->sections[] = array(
			...
			'fields'    => array(
                ...
                array(
					'id'        => 'application_welcome',
					'type'      => 'text',
					'title'     => esc_html__('Welcome Message', 'application'),
					'default'   => esc_html__(' Welcome to GTW Bauwert ', 'application')
				),
                array(
                ...
                array(
					'id'        => 'application_time',
					'type'      => 'text',
					'title'     => esc_html__('Your Office Time', 'application'),
					'default'   => esc_html__(' 9AM - 5PM ', 'application')
				),
				array(
					'id'        => 'application_mail',
					'type'      => 'text',
					'title'     => esc_html__('Your Email', 'application'),
					'default'   => esc_html__('info@gtwbauwert.de', 'application')
				),	
                array(
				...
				array(
					'id'        => 'application_linkedin',
					'type'      => 'text',
					'title'     => esc_html__('Your Linkedin', 'application'),
					'default'   => esc_html__('https://www.yourprofile.com', 'application')
				),
        ...
        // About Content
		$this->sections[] = array(
			'title'     => esc_html__('About Content', 'application'),
			'desc'      => esc_html__('About Content theme options', 'application'),
			'icon'      => 'el el-adult',
			'fields'    => array(
                array(
					'id' => 'about_image',
					...
					'compiler' => 'true',
					'desc' => esc_html__('Basic media uploader with disabled URL input field.', 'application'),
					'subtitle' => esc_html__('Add/Upload using the WordPress native uploader', 'application'),
					'title' => esc_html__('About Image', 'application'),
					'default' => array(
						'url' => APPLICATION_IMAGES . '/about-pic-s3.png',
					),
                ),
                array(
					'id'        => 'main_title',
					'type'      => 'text',
					'title'     => esc_html__('About', 'application'),
					'default'   => esc_html__('Über', 'application')
				),
                array(
					'id'        => 'about_title',
					'type'      => 'text',
					'title'     => esc_html__('About Company', 'application'),
					'default'   => esc_html__('ÜBER UNSERE FIRMA', 'application')
				),
                array(
					'id'        => 'about_subtitle',
					'type'      => 'text',
					'title'     => esc_html__('About Company Sbtitle', 'application'),
					'default'   => esc_html__('Ein bisschen über uns', 'application')
                ),
                array(
					'id'      	=> 'about_content',
					'type'    	=> 'editor',
                ...
                array(
					'id'        => 'about_button',
					'type'      => 'text',
					'title'     => esc_html__('About Button', 'application'),
					'default'   => esc_html__('Über uns', 'application')
                ),
                array(
					'id'        => 'about_button_url',
					'type'      => 'text',
					'title'     => esc_html__('About Button URL', 'application'),
        ...
        // Services Content
		$this->sections[] = array(
			'title'     => esc_html__('Services Content', 'application'),
			'desc'      => esc_html__('Services options', 'application'),
			'icon'      => 'el el-adult',
			'fields'    => array(
                array(
					'id'        => 'services_main_title',
					'type'      => 'text',
					'title'     => esc_html__('Services', 'application'),
					'default'   => esc_html__('Leistungen', 'application')
				),                                                   
                array(
					'id'        => 'services_title',
					'type'      => 'text',
					'title'     => esc_html__('Services Title', 'application'),
					'default'   => esc_html__('Unsere Leistungen', 'application')
				),                                                   
                array(
					'id'        => 'services_subtitle',
					'type'      => 'text',
					'title'     => esc_html__('What we do', 'application'),
					'default'   => esc_html__('Unsere Leistungen', 'application')
				)                                                   
        ...
        // Features
		$this->sections[] = array(
			'title'     => esc_html__('Features', 'application'),
			'desc'      => esc_html__('Features theme options', 'application'),
			'icon'      => 'el el-adult',
			'fields'    => array(
				array(
					'id'        => 'features_title',
					'type'      => 'text',
					'title'     => esc_html__('Features Title', 'application'),
					'default'   => esc_html__('Unsere Spezialisierung', 'application')
                ),           
				array(
					'id'        => 'features_subtitle',
					'type'      => 'text',
					'title'     => esc_html__('Features Title', 'application'),
					'default'   => esc_html__('Spezialität', 'application')
                ),           
			),
		);
        // Product
		$this->sections[] = array(
			'title'     => esc_html__('Product', 'application'),
			'desc'      => esc_html__('Product theme options', 'application'),
			'icon'      => 'el el-adult',
			'fields'    => array(
				array(
					'id'        => 'products_main_title',
					'type'      => 'text',
					'title'     => esc_html__('Product Title', 'application'),
					'default'   => esc_html__('Produkts', 'application')
                ),
				array(
					'id'        => 'products_title',
					'type'      => 'text',
					'title'     => esc_html__('Product Title', 'application'),
					'default'   => esc_html__('Letzte Produkts', 'application')
                ),
				array(
					'id'        => 'products_subtitle',
					'type'      => 'text',
					'title'     => esc_html__('Product Title', 'application'),
					'default'   => esc_html__('ZULETZT BEENDET ', 'application')
                ),
        ...
        // Blog
		$this->sections[] = array(
			'title'     => esc_html__('Blog', 'application'),
			'desc'      => esc_html__('Blog theme options', 'application'),
			'icon'      => 'el el-adult',
			'fields'    => array(
				array(
					'id'        => 'blog_mian_title',
					...
					'default'   => esc_html__('Blogs', 'application')
                ),
				array(
					'id'        => 'blog_title',
					'type'      => 'text',
					'title'     => esc_html__('Blog Title', 'application'),
					'default'   => esc_html__('Neuesten Nachrichten', 'application')
                ),
				array(
					'id'        => 'blog_subtitle',
					'type'      => 'text',
					'title'     => esc_html__('Blog Title', 'application'),
					'default'   => esc_html__('Letzter Blog ', 'application')
                ),
        ...
        // Contact
		$this->sections[] = array(
			'title'     => esc_html__('Contact', 'application'),
			'desc'      => esc_html__('Contact theme options', 'application'),
			'icon'      => 'el el-adult',
			'fields'    => array(
				array(
					'id'        => 'contact_title',
					...
					'default'   => esc_html__('Rückruf anfordern', 'application')
                ),
				array(
					'id'        => 'contact_subtitle',
					'type'      => 'text',
					'title'     => esc_html__('Contact Sub Title', 'application'),
					'default'   => esc_html__('Wenn Sie Fragen haben oder ein Projekt starten möchten, zögern Sie nicht, mit uns Kontakt aufzunehmen. ', 'application')
                ),
                array(
					'id'      	=> 'contact_content',
					'type'    	=> 'editor',
                ...
                array(
					...
					'desc' => esc_html__('Basic media uploader with disabled URL input field.', 'application'),
					'subtitle' => esc_html__('Add/Upload using the WordPress native uploader', 'application'),
					'title' => esc_html__('Contact Image', 'application'),
					'default' => array(
						'url' => APPLICATION_IMAGES . '/contact-pic.jpg',
					),
                ),
        ...
        // Services Page
		$this->sections[] = array(
			'title'     => esc_html__('Services Page', 'application'),
			'desc'      => esc_html__('Services Page theme options', 'application'),
			'icon'      => 'el el-adult',
			'fields'    => array(
				...
				array(
					'id'        => 'services_title',
					'type'      => 'text',
					'title'     => esc_html__('Services Page First Section Title', 'application'),
					'default'   => esc_html__('Liste der Dienste', 'application')
                ),
                array(
					'id'      	=> 'services_content',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Services Page First Content', 'application'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'application'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
				...
				array(
					'id'        => 'services_title2',
					'type'      => 'text',
					'title'     => esc_html__('Services Page Second Section Title', 'application')
                ),
                array(
					'id'      	=> 'services_content2',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Services Page Second Content', 'application'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'application'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
				...
				array(
					'id'        => 'services_title3',
					'type'      => 'text',
					'title'     => esc_html__('Services Page Third Section Title', 'application')
                ),
                array(
					'id'      	=> 'services_content3',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Services Page Third Content', 'application'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'application'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
