...
if (!is_admin()) {
	...
	wp_enqueue_style('owl.carousel', APPLICATION_CSS . '/owl.carousel.min.css', '', null);  
	wp_enqueue_style('owl.theme.default.min-css', APPLICATION_CSS . '/owl.theme.default.min.css', '', null);  
...
if (!is_admin()) {
    ...
    wp_enqueue_script('bootstrap-popper', APPLICATION_SCRIPTS . '/popper.min.js', array('jquery'), '', true);
    ...
    wp_enqueue_script('owl.carousel.min', APPLICATION_SCRIPTS . '/owl.carousel.min.js', array('jquery'), '', true);
