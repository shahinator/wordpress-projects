...
if (!class_exists('Application_Theme_Config')) {
    ...
    class Application_Theme_Config {
       ...
       public function setSections() {
		...
		$this->sections[] = array(
			...
			'fields'    => array(
				array(
					...
					'title' => esc_html__('Left Side Logo', 'application'),
					'default' => array(
                ...
                array(
					...
					'type'      => 'text',
					'title'     => esc_html__('Your Muscat Phone Nubmer', 'application'),
					'default'   => esc_html__(' (+968) 1235465) ', 'application')
				),
                array(
					'id'        => 'application_phone2',
					'type'      => 'text',
					'title'     => esc_html__('Your Salah Phone Nubmer', 'application'),
					'default'   => esc_html__(' (+968) 5652365 ', 'application')
				),
				array(
					'id'        => 'application_mail',
					'type'      => 'text',
					'title'     => esc_html__('Your Email', 'application'),
					'default'   => esc_html__(' info@megaelevators.com ', 'application')
				),
                array(
		...
		$this->sections[] = array(
			...
			'fields'    => array(
				array(
					...
					'default'	=> esc_html__('© 2019 Mega Elevators. All right reserved   |   powered by estring media' , 'application'),
					'args' 		=> array(
						'teeny'            => true,
						'textarea_rows'    => 5,
						'media_buttons'	=> false,
        ...
        // marketing Content
		$this->sections[] = array(
			'title'     => esc_html__('Marketing Network', 'printagram18'),
			'desc'      => esc_html__('Marketing Network theme options', 'printagram18'),
			'icon'      => 'el el-adult',
			'fields'    => array(
                array(
					'id'        => 'marketing_title',
					'type'      => 'text',
					'title'     => esc_html__('Marketing Title', 'application'),
                    'default'   => esc_html__('Marketing Network', 'application')
				),
                array(
					'id'      	=> 'marketing_content',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Marketing Content', 'printagram18'),
        ...
        // ceo Content
		$this->sections[] = array(
			'title'     => esc_html__('CEO Message', 'printagram18'),
			'desc'      => esc_html__('CEO Message theme options', 'printagram18'),
			'icon'      => 'el el-quote-alt',
			'fields'    => array(
                array(
					'id'        => 'ceo_title',
					'type'      => 'text',
					'title'     => esc_html__('CEO Text Title', 'application'),
                    'default'   => esc_html__('CEO Message', 'application')
				),
                array(
					'id'      	=> 'ceo_content',
					'type'    	=> 'editor',
                ...
                array(
                    'id'        => 'ceo_name',
                    'type'      => 'text',
                    'title'     => esc_html__('Name', 'application'),
                    'default'   => esc_html__('Abdul Shukkoor', 'application')
                ),
                array(
                    'id'        => 'ceo_designation',
                    'type'      => 'text',
                    'title'     => esc_html__('Desination', 'application'),
                    'default'   => esc_html__('CEO , Mega Corporation', 'application')
                ),
                array(
					'id'      	=> 'ceo_announcement',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('CEO Announcement', 'printagram18'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'printagram18'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
		...
		$this->sections[] = array(
			'title'     => esc_html__('Mission & Vision', 'printagram18'),
			'desc'      => esc_html__('Mission & Vision theme options', 'printagram18'),
			'icon'      => 'el el-asl',
			'fields'    => array(
                array(
					'id'        => 'mission_vision_title',
					'type'      => 'text',
					'title'     => esc_html__('Mission & Vision Title', 'application'),
                    'default'   => esc_html__('Mission & Vision', 'application')
				),
                array(
					'id'      	=> 'mission_vision_content',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Mission & Vision Content', 'printagram18'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'printagram18'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
        ...
        // Chairman mesages Content
		$this->sections[] = array(
			'title'     => esc_html__('Chairman mesages', 'printagram18'),
			'desc'      => esc_html__('Chairman mesages theme options', 'printagram18'),
			...
			'fields'    => array(
                array(
					...
					'title' => esc_html__('Chairman Image', 'application'),
					'default' => array(
						'url' => APPLICATION_IMAGES . '/chairman.png',
					),
                ),
                array(
					'id'        => 'chairman_title',
					'type'      => 'text',
					'title'     => esc_html__('Chairman mesages Title', 'application'),
                    'default'   => esc_html__('Chairman mesages', 'application')
				),
                array(
					'id'      	=> 'chairman_content',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Chairman mesages Content', 'printagram18'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'printagram18'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
                ...
                array(
					...
					'title' => esc_html__('Chairman Image', 'application'),
					'default' => array(
						'url' => APPLICATION_IMAGES . '/singnature.png',
					),
                ),
                array(
					'id'        => 'chairman_name',
					'type'      => 'text',
					'title'     => esc_html__('Chairman Name', 'application'),
                    'default'   => esc_html__('Abdul Muhamed', 'application')
				),                                                  
                array(
					'id'        => 'chairman_designation',
					'type'      => 'text',
					'title'     => esc_html__('Chairman Designation', 'application'),
                    'default'   => esc_html__('Chairman, Mega Elevator', 'application')
				),                                                  
        ...
        // Our Product Content
		$this->sections[] = array(
			'title'     => esc_html__('Our Project', 'printagram18'),
			'desc'      => esc_html__('Our Project theme options', 'printagram18'),
			'icon'      => 'el el-arrow-right',
			'fields'    => array(
                array(
					'id'        => 'our_projects',
					'type'      => 'text',
					'title'     => esc_html__('Project Title', 'application'),
                    'default'   => esc_html__('Our Projects', 'application')
				)                                                 
        ...
        // Our Product Content
		$this->sections[] = array(
			'title'     => esc_html__('Related Products', 'printagram18'),
			'desc'      => esc_html__('Related Products theme options', 'printagram18'),
			'icon'      => 'el el-arrow-right',
			'fields'    => array(
                array(
					'id'        => 'related_project',
					'type'      => 'text',
					'title'     => esc_html__('Related Product Title', 'application'),
                    'default'   => esc_html__('Related Products', 'application')
				)                                                 
        ...
        // Gallery Content
		$this->sections[] = array(
			'title'     => esc_html__('Gallery', 'printagram18'),
			'desc'      => esc_html__('Gallery theme options', 'printagram18'),
			'icon'      => 'el el-arrow-right',
			'fields'    => array(
                array(
					'id'        => 'gallery_title',
					'type'      => 'text',
					'title'     => esc_html__('Gallery Title', 'application'),
                    'default'   => esc_html__('Gallery', 'application')
                ),   
                array(
					'id'      	=> 'gallery_text',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Put Here Gallery Text', 'printagram18'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'printagram18'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
		...
		$this->sections[] = array(
			'title'     => esc_html__('Current Opening', 'printagram18'),
			'desc'      => esc_html__('Current Opening theme options', 'printagram18'),
			'icon'      => 'el el-arrow-right',
			'fields'    => array(
                array(
					'id'        => 'opening_title',
					'type'      => 'text',
					'title'     => esc_html__('Current Opening Title', 'application'),
                    'default'   => esc_html__('Current Opening', 'application')
                ),   
                array(
					'id'      	=> 'opening_text',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Put Here Current Opening Text', 'printagram18'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'printagram18'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
                ...
                array(
					'id'      	=> 'opening_sidebar',
					'type'    	=> 'editor',
					'title'   	=> esc_html__('Put Here Current Sidebar Text', 'printagram18'),
					'subtitle'	=> esc_html__('HTML tags allowed: a, br, em, strong', 'printagram18'),
                    'args' 		=> array(
                        'teeny'            => true,
                        'textarea_rows'    => 5,
		...
		$this->sections[] = array(
			'title'     => esc_html__('Contact Page', 'printagram18'),
			'desc'      => esc_html__('Contact Page theme options', 'printagram18'),
			'icon'      => 'el el-arrow-right',
			'fields'    => array(
                array(
					'id'        => 'contact_title',
                    ...
                    'default'   => esc_html__('Contact', 'application')
                ),                                           
                array(
					'id'        => 'quote_now_title',
					'type'      => 'text',
					'title'     => esc_html__('Quote Now Title', 'application'),
                    'default'   => esc_html__('Quote Now', 'application')
                ),                                           
