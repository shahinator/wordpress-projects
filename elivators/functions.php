...
if ( ! function_exists( 'application_setup' ) ) :
	...
	function application_setup() {
		...
		register_nav_menus( array(
			'header' => esc_html__( 'Header', 'application' ),
			'product-menu' => esc_html__( 'Products Menu', 'application' ),
		) );
		/*
...
function application_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer One', 'application' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add Footer Content Here.', 'application' ),
		'before_widget' => '<div class="col-lg-3 col-md-12">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Two /Three / Four / Five', 'application' ),
		'id'            => 'footer',
		'description'   => esc_html__( 'Add Footer Content Here.', 'application' ),
		'before_widget' => '<div class="col-lg-2 col-md-6"><div class="single-list">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Six', 'application' ),
		'id'            => 'footer-6',
		'description'   => esc_html__( 'Add Footer Content Here.', 'application' ),
		'before_widget' => '<div class="col-lg-4 col-md-6"><div class="contact">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
