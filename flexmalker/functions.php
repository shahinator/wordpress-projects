...
function application_widgets_init() {
	...
	register_sidebar( array(
		...
		'before_widget' => '<div class="footer-widget touch-widget"><div class="footer_one">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<h2 style="display:none">',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Two', 'application' ),
		'id'            => 'footer-2',
		'description'   => esc_html__( 'Add Footer Content Here.', 'application' ),
		'before_widget' => '<div class="footer-widget links-widget">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Three', 'application' ),
		'id'            => 'footer-3',
		'description'   => esc_html__( 'Add Footer Content Here.', 'application' ),
		'before_widget' => '<div class="footer-widget links-widget">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Four', 'application' ),
		'id'            => 'footer-4',
		'description'   => esc_html__( 'Add Footer Content Here.', 'application' ),
		'before_widget' => '<div class="footer-widget links-widget">',
		'after_widget'  => '</div>',
